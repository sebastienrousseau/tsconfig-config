# `@sebastienrousseau/tsconfig-config` Examples Catalog

This directory provides runnable, standalone examples covering **100% of the functionalities and features** provided by `@sebastienrousseau/tsconfig-config`.
...
- [x] **Base Compiler Preset**: Strict type-checking foundation (`base`)
- [x] **Node.js Target Preset**: Optimized for modern Node.js runtimes with NodeNext resolution (`node`)
- [x] **Web Browser Preset**: Optimized for client-side bundlers with DOM library inclusion (`web`)
- [x] **Strict Mode Defaults**: Enforces strict null checks, no implicit any, and exhaustive switch checks
