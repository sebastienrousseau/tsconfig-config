...
This document describes how @sebastienrousseau/tsconfig-config is run: who decides what, how
...
@sebastienrousseau/tsconfig-config is **maintainer-led**. As of the current release line it has a single
