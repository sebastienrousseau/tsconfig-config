...
# Packaging @sebastienrousseau/tsconfig-config
...
-  `base.json`, `node.json`, `web.json` — the tool-native preset file(s)
...
| :----- | :--- | :---------- |
| Debian | [`pkg/deb/`](../pkg/deb) | `/usr/share/nodejs/@sebastienrousseau/tsconfig-config/` |
| RPM | [`pkg/rpm/`](../pkg/rpm) | `/usr/lib/node_modules/@sebastienrousseau/tsconfig-config/` |
| Arch | [`pkg/aur/PKGBUILD`](../pkg/aur/PKGBUILD) | `/usr/lib/node_modules/@sebastienrousseau/tsconfig-config/` |
| Homebrew | [`pkg/brew/tsconfig-config.rb`](../pkg/brew/tsconfig-config.rb) | formula cellar |
| Nix | [`pkg/nix/flake.nix`](../pkg/nix/flake.nix) | `$out/lib/node_modules/@sebastienrousseau/tsconfig-config/` |
